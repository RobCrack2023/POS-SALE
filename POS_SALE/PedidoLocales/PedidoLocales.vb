...
Public Class PedidoLocales
    ...
    Private Sub CargaSucursal()
        ...
        cmbsucursaladm.DataSource = tablas
        cmbsucursaladm.DisplayMember = "nom_sucursal"
        cmbsucursaladm.ValueMember = "id_sucursal"
    ...
    Private Sub btnenviar_Click(sender As Object, e As EventArgs) Handles btnenviar.Click
        Dim sql As String
        Dim idsucursaltemporal As Integer
        Dim objconnn As DBCONECTAR = New DBCONECTAR
        Dim tablas As DataTable = New DataTable()
        ...
        If MsgBox("Desea Solicitar el pedido ", MsgBoxStyle.YesNo) = MsgBoxResult.No Then
        ...
        If idsucursalpublic = 13 Then

            idsucursaltemporal = cmbsucursal.SelectedValue
        Else

            idsucursaltemporal = idsucursalpublic
        ...
        sql = sql & " VALUES ( (select max(b.idpedido_cab)+1 from pedidolocal_cab b)," & idsucursaltemporal & ",1," & cmbturno.SelectedValue & ",''," & usr & ",'" & Format(CDate(txtfechaped.Text), "yyyy-MM-dd") & "', DATE_FORMAT(NOW(),'%Y-%m-%d') ,DATE_FORMAT(NOW(),'%H:%i'))"
        objconnn.executarmysqlinsert(sql)
        ...
        Catch ex As Exception
            MsgBox("Error al imprimir pedido." & vbCrLf &
    ...
    Sub BuscarPedidos()
        ...
        sql = sql & " WHERE  a.estadopedloc=" & cmbestado.SelectedValue & " and  a.id_sucursal= " & idsucursalpublic & " and "
    ...
    Private Sub btnselecsucursal_Click(sender As Object, e As EventArgs) Handles btnselecsucursal.Click


        btnselecsucursal.Image = StrindbergNet.My.Resources.Resources.accept_red

        txtfechaped.Enabled = False
